...
export const StreamPlayer = ({
  ...
  const { token, name, identity } = useViwerToken(user.id);
  ...
  return (
    <>
      {collapsed && (
        <div className="hidden lg:block fixed top-[66px] right-2 z-50">
          <ChatToggle />
        </div>
      )}
      <LiveKitRoom
...
export const StreamPlayerSkeleton = () => {
  return (
    <div className="grid grid-cols-1 lg:gap-y-0 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-5 h-full">
      <div className="space-y-4 col-span-1 lg:col-span-1 xl:col-span-2 2xl:col-span-4 lg:opverflow-y-auto hidden-scrollbar pb-10">
        <VideoSkeleton />
        <HeaderSkeleton />
      </div>
